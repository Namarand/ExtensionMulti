...
public class Static_IA : MonoBehaviour {

	public float angle = 360f; // Angle d'ouverture, degré
	public float distance = 5f;
	public int precision = 40; // Nombre de rayons lancé dans l'angle ci dessus
